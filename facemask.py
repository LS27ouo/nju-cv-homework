...
from face_mask.__main__ import DEFAULT_IMAGE_PATH
from face_mask.__main__ import BLACK_IMAGE_PATH
from face_mask.__main__ import BLUE_IMAGE_PATH
from face_mask.__main__ import RED_IMAGE_PATH
...
class FaceMasker:
    ...
    def _mask_face(self, face_landmark: dict):
        ...
        # split mask and resize   拆分口罩并调整大小
        ...
        # calculate mask location   计算口罩位置
...
if __name__ == '__main__':
    FaceMasker("./face/05.jpg", DEFAULT_IMAGE_PATH, True, 'hog').mask()
